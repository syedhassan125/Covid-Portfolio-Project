...
Select
location,date as peak_date,new_cases as peak_new_cases
From
[Portfolio Project]..Coviddeaths
Join
Maxnewcasesperlocation on [Portfolio Project]..Coviddeaths.location = maxnewcasesperlocation.location
and [Portfolio Project].new_cases= maxnewcasesperlocation.max_new_cases
...
--Join the two temporary tables you created and calculate the correlation between total deaths and total vaccinations.

--Calculate the daily new cases for each location from the Covid Deaths data and store the results in a temporary table.

--Calculate the daily new vaccinations for each location from the Covid Vaccination data and store the results in a temporary table.

--Join the two temporary tables you created for daily new cases and daily new vaccinations, and calculate the correlation between them.

--Find the location with the highest total number of deaths and display its details.

--Find the location with the highest total number of vaccinations and display its details
